...
class Event(models.Model):
    event_type = models.ForeignKey('EventType', on_delete=models.CASCADE, related_name='event_eventype', verbose_name="Event Type")
    room_reservation = models.ForeignKey('RoomReservation', on_delete=models.CASCADE, related_name='event_roomreservation', verbose_name="Event Reservation")
...
class Entity(models.Model):
    ...
    class Meta:
        db_table = 'entities_event'
        ordering = ['name']
        verbose_name = "Entity"
        verbose_name_plural = "Entities"

class Room(models.Model):
    departmental_council = models.ForeignKey(DepartmentalCouncil, on_delete=models.CASCADE, related_name='room_departmentalcouncil', verbose_name="Departmental Council")
    ...
    class Meta:
        db_table = 'rooms_event'
        verbose_name = "Room"
        verbose_name_plural = "Rooms"

class RoomReservation(models.Model):
    entity = models.ForeignKey('Entity', on_delete=models.CASCADE, related_name='roomreservation_entity', verbose_name="Entity", null=True, blank=True)
    natural_person = models.ForeignKey(Person, on_delete=models.CASCADE, related_name='roomreservation_naturalperson', verbose_name="Natural Person", null=True, blank=True)
    ...
    class Meta:
        db_table = 'room_reservations_event'
...
class EventInscription(models.Model):
    event = models.ForeignKey('Event', on_delete=models.CASCADE, related_name='eventinscription_event', verbose_name="Event")
    participant = models.ForeignKey('Participant', on_delete=models.CASCADE, related_name='eventinscription_participant', verbose_name="Participant")
    ...
    class Meta:
        db_table = 'event_inscriptions_event'
        ordering = ['inscription_date']
        verbose_name = "Event Inscription"
        verbose_name_plural = "Event Inscriptions"

class Participant(models.Model):
    person = models.ForeignKey(Person, on_delete=models.CASCADE, related_name='participant_person', verbose_name="Person")
    ...
    class Meta:
        db_table = 'participants_event'
        ordering = ['register_date']
        verbose_name = "Participant"
        verbose_name_plural = "Participants"

class CertificateSignature(models.Model):
    executive = models.ForeignKey('Executive', on_delete=models.CASCADE, related_name='certificatesignature_executive', verbose_name="Executive", null=True, blank=True)
    entity = models.ForeignKey('Entity', on_delete=models.CASCADE, related_name='certificatesignature_entity', verbose_name="Entity", null=True, blank=True)
    ...
    class Meta:
        db_table = 'certificate_signatures_event'
        verbose_name = "Certificate Signature"
        verbose_name_plural = "Certificate Signatures"

class EventCertificate(models.Model):
    event = models.ForeignKey('Event', on_delete=models.CASCADE, related_name='eventcertificate_event', verbose_name="Event")
    ...
    class Meta:
        db_table = 'event_certificates_event'
        ordering = ['issue_date']
...
class SignatureRole(models.Model):
    ...
    class Meta:
        db_table = 'signature_roles_event'
        verbose_name = "Signature Role"
        verbose_name_plural = "Signature Roles"

class EventSignature(models.Model):
    event = models.ForeignKey('Event', on_delete=models.CASCADE, related_name='eventsignature_event', verbose_name="Event")
    certificate_signature = models.ForeignKey("CertificateSignature", on_delete=models.CASCADE, related_name='eventsignature_certificatesignature', verbose_name="Signature")
    signature_role = models.ForeignKey('SignatureRole', on_delete=models.CASCADE, related_name='eventsignature_signaturerole', verbose_name="Role")

    class Meta:
        db_table = 'event_signatures_event'
        verbose_name = "Event Signature"
        verbose_name_plural = "Event Signatures"

class EventAttendee(models.Model):
    participant = models.ForeignKey('Participant', on_delete=models.CASCADE, related_name='eventattendee_participant', verbose_name="Participant")
    ...
    class Meta:
        db_table = 'event_attendee_event'
        ordering = ['date']
        verbose_name = "Event Assistant"
        verbose_name_plural = "Event Assistants"

class Speaker(models.Model):
    person = models.ForeignKey(Person, on_delete=models.CASCADE, related_name='speaker_person', verbose_name="Person")
    engineer = models.ForeignKey(Engineer, on_delete=models.CASCADE, related_name='speaker_engineer', verbose_name="Engineer", null=True, blank=True)
    ...
    class Meta:
        db_table = 'speakers_event'
        verbose_name = "Speaker"
        verbose_name_plural = "Speakers"

class EventSpeaker(models.Model):
    event = models.ForeignKey('Event', on_delete=models.CASCADE, related_name='eventspeaker_event', verbose_name="Event")
    speaker = models.ForeignKey('Speaker', on_delete=models.CASCADE, related_name='eventspeaker_speaker', verbose_name="Speaker")
    ...
    class Meta:
        db_table = 'event_speakers_event'
        ordering = ['start_time']
        verbose_name = "Event Speaker"
        verbose_name_plural = "Event Speakers"

class Executive(models.Model):
    engineer = models.ForeignKey(Engineer, on_delete=models.CASCADE, related_name='executive_engineer', verbose_name="Engineer")
    position = models.ForeignKey('Position', on_delete=models.CASCADE, related_name='executive_position', verbose_name="Position")
    period = models.ForeignKey('Period', on_delete=models.CASCADE, related_name='executive_period', verbose_name="Period")
    start_date = models.DateField(verbose_name="Start Date")
    end_date = models.DateField(verbose_name="End Date", null=True, blank=True)
    status = models.CharField(max_length=20, verbose_name="Status", choices=[
        ('1', 'ACTIVO'),
